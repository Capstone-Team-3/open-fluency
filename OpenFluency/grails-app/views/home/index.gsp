                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <section>
                                ...
                                <p class="role h4">Sign up as a <strong>Student</strong> to:</p>
                                <ul>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <section>
                                ...
                                <p class="role h4">Sign up as an <strong>Instructor</strong> to:</p>
                                <ul>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <section>
                                ...
                                <p class="role h4">Sign up as a <strong>Researcher</strong> to:</p>
                                <ul>
