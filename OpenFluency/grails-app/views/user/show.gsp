			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="userType-label" class="property-label"><g:message code="user.userType.label" default="User Type" /></span>
						...
						<span class="property-value" aria-labelledby="userType-label"><g:link controller="role" action="show" id="${userInstance?.userType?.id}">${userInstance?.userType?.encodeAsHTML()}</g:link></span>
