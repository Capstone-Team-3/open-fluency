            ...
            <table class="table table-bordered courses-table">
                <thead>
                    ...
                    <tr class="active">
                        <g:each in="${courseInstance.chapters}">
                            <th>
                                Meanings (${courseInstance.chapters[0].deck.language} to ${courseInstance.chapters[0].deck.sourceLanguage})
                            </th>
                            <th>
                                Meanings (${courseInstance.chapters[0].deck.sourceLanguage} to ${courseInstance.chapters[0].deck.language})
                            </th>
                            <th>
                                Pronunciations in ${courseInstance.chapters[0].deck.language}
                            </th>
                        </g:each>
