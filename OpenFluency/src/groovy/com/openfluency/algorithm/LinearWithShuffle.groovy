...
class LinearWithShuffle extends CardServiceAlgorithm{
	...
	*/
	FlashcardInfo buildNewFlashcardInfo(Flashcard flashcardInstance) {
		return new FlashcardInfo(flashcard: flashcardInstance, viewPriority: 1.0)
	}
